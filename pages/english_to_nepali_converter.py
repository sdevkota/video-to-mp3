...
# Page configuration
st.set_page_config(
    page_title="English to Nepali Translator & Font Converter",
    page_icon="🇳🇵",
    layout="wide"
)
...
# Main app header
st.markdown("<h1 class='main-header'>🇳🇵 English to Nepali Translator & Font Converter</h1>", unsafe_allow_html=True)
...
with tab2:
    ...
    with col2:
        ...
        if 'converted_text' in st.session_state:
            st.markdown(f"""
            <div class='translation-box'>
                <div class='nepali-text'>{st.session_state['converted_text']}</div>
            </div>
            """, unsafe_allow_html=True)
